...
def Siniflandir(resim,veri_isimler,veri_resimler):
    ...
    cv2.putText(kare, veri_isimler[min_index], (250, 250), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 0), 2)
...
while True:
    ...
    _, cnts, _ = cv2.findContours(renk_filtresi_sonuc,cv2.RETR_TREE,cv2.CHAIN_APPROX_NONE)
    max_genislik = 0
    max_uzunluk = 0
    max_index = -1
